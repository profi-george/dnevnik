/**
 * Иконки — инлайн-SVG (контуры Lucide, лицензия ISC), без внешней зависимости.
 * Никаких эмодзи и текстовых глифов вроде «✕» в интерфейсе.
 * Размер задаётся классом (по умолчанию 14×14), цвет — currentColor.
 */
...
/** Индикатор загрузки. Крутится только если пользователь не просил убрать анимацию. */
